...
let customScale = 1;
let targetFps = 60;
let bgmfile = './assets/audio/KIRISAME.flac';
let bgmvolume = 0;
let bgm;
...
const AUDIO_DETAIL = [
	{
		...
		dialog: {
			Japanese: [
				"先生。私、自分のするべきことが分かりました。",
				"考えてみれば当たり前のことなのに、今になって気づくとは…シズコ、一生の不覚！"
			],
			English: [
	...
	},
	{
		...
		dialog: {
			Japanese: [
				"知ってるかもしれませんが、私って欲張りなんですよ？",
				"やりたいことも、欲しい物もたくさんありますが、一つも諦めません。"
			],
			English: [
			...
			Chinese: [
				"虽然您已经可能知道了，但我可是很贪心的哦？",
				"想做的事情，想要的东西，我一个也不想放弃。"
			]
		}
	},
	{
		...
		dialog: {
			Japanese: [
				"みんなを喜ばせることも、商売としての成功も！",
				"百夜堂を、キヴォトスいちの喫茶店にすることも！"
			],
			English: [
...
const HITBOX = {
	headpat: { xMin: 700, xMax: 1360, yMin: 100, yMax: 400 },
	voiceline: { xMin: 1160, xMax: 1980, yMin: 750, yMax: 1400 }
};
